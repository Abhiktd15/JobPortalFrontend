        ...
        <div>
            ...
            <div className='max-w-7xl mx-auto my-10'>
                <div className='flex items-center justify-between'>
                    ...
                    <button onClick={isApplied ? null : applyJobHandler} disabled={isApplied} className={`border px-3 py-2 rounded-lg ${isApplied?"bg-gray-600 cursor-not-allowed":"bg-[#7209b7] hover:bg-[#af51ee]"} text-white font-medium hover:bg-gray-700`}>
                ...
                <div className='my-4'>
                    ...
                    <h1 className='font-bold my-1'>Requirements: {singleJob?.requirements?.map(item => <span key={item?._id} className='pl-4 font-normal text-gray-800'>{item} </span>)} </h1>
