    ...
    return (
        <div className='text-center '>
            <div className='flex flex-col gap-5 my-10'>
                ...
                <p>Lorem Ipsum dolor set amit dispadfklk j;ljadkjf ;adlkjfak; jfdkajf ;akljf ;adkjf;kald jfkadjf ;akldjfkladj</p>
                <div className='flex w-[40%] h-10 shadow-lg border border-gray-200 pl-4 rounded-full items-center gap-4 mx-auto'>
                    ...
                    <button className='rounded-r-full h-full bg-orange-400 '>
