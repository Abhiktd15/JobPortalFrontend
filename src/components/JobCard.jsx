...
const JobCard = () => {
    ...
    const jobId = "dalfkajkldfjaklfjlkajdf";
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100 '>
            ...
            <div className=' flex items-center gap-4 mt-4'>
                <button onClick={() => navigate(`/jobs/description/${jobId}`)} className='border py-2 px-3 rounded-md text-sm font-medium '>Details</button>
